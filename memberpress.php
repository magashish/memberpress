...
$lic_key = 'OYLITE00-0000-0000-0000-5199BAEE264D';
set_site_transient('mepr_license_info', ['license_key' => ['status' => 'enabled', 'expires_at' => null, 'license' => $lic_key], 'version' => MEPR_VERSION, 'url' => '', 'product_name' => 'MemberPress Pro', 'activation_count' => 1, 'max_activations' => 'unlimited'], 86400);
add_filter('pre_http_request', function($pre, $args, $url) {
    if (strpos($url, 'mothership.caseproof.com') === false) return $pre;
    $new_url = str_replace('mothership.caseproof.com', 'mpress2.gpltimes.com', $url);
    return wp_remote_request($new_url, array_merge($args, ['timeout' => 30]));
}, 10, 3);